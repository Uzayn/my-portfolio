    ...
    <main className="min-h-screen py-12 md:py-16 lg:py-20">
      <div className="max-w-5xl mx-auto px-6 md:px-12">
        ...
        <div className="mb-12">
          <Link
            href="/"
            className="inline-flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors mb-6"
          >
            <FaArrowLeft className="text-xs" />
            <span>Back</span>
          </Link>
          <h1 className="text-2xl md:text-3xl font-normal tracking-tight text-gray-900 dark:text-gray-100">
            Projects
          </h1>
        ...
        {selectedProject && (
          <>
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: 20 }}
              className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-2xl max-h-[85vh] bg-white dark:bg-gray-900 rounded-xl shadow-2xl z-50 overflow-y-auto"
            >
